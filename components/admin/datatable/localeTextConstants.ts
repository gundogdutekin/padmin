...
export const GRID_DEFAULT_LOCALE_TEXT: GridLocaleText = {
  ...
  aggregationFunctionLabelSize: 'boyut',// Root
  ...
  headerFilterOperatorNot: 'değildir',
  headerFilterOperatorAfter: 'sonra',
  headerFilterOperatorOnOrAfter: 'tarihinde veya sonrasında',
  headerFilterOperatorBefore: 'önce',
  headerFilterOperatorOnOrBefore: 'tarihinde veya öncesinde',
  headerFilterOperatorIsEmpty: 'boş',
  headerFilterOperatorIsNotEmpty: 'boş değil',
  headerFilterOperatorIsAnyOf: 'herhangi biri',
  'headerFilterOperator=': 'Eşit',
  'headerFilterOperator!=': 'Eşit Değil',
  'headerFilterOperator>': 'Büyük',
  'headerFilterOperator>=': 'Büyük veya eşittir',
  'headerFilterOperator<': 'Küçük',
  ...
  MuiTablePagination: {
    ...
    labelDisplayedRows: ({ from, to, count }) => `${from}-${to} / ${count !== -1 ? count : ` ${to} dan fazla`}`,
  },
